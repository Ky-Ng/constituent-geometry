...
def main() -> None:
    ...
    # NOTE: full-validation-set eval was moved OUT of training (exp 20) into a
    # separate script -- experiments/20_multi_seed_random_depth2_small_models/
    # run_full_evaluate.py -- so each run only does capped (--max-eval-samples)
    # eval and finishes faster across all seeds. Run that script post-hoc to score
    # the saved best/ checkpoint on the ENTIRE validation set.
