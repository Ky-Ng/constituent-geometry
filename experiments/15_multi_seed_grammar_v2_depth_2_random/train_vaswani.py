"""Train the Vaswani encoder-decoder for experiment 15 (v2 grammar + adjunction).

Copy of experiments/06_vaswani_original_hi_hf_frames_heads_4_layers_4/run.py with
two additions:
...
identical to experiment 06 so the two runs are directly comparable.

To copy: rename this file to train_vaswani.py.
"""
...
def main() -> None:
    ...
    p.add_argument("--output-dir",
                   default=os.path.join(EXP_DIR, "results", "vaswani", "seed_0"))
    ...
    p.add_argument("--run-name",
                   default="15_multi_seed_grammar_v2_depth_2_random_vaswani_seed_0")
